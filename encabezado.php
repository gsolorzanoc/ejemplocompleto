...
<div class="pastillas">
	<ul class="nav justify-content-center">
  		...
  		<li class="nav-item">
    		<a class="nav-link" href="indexempleado.php">Empleados</a>
  		</li>
  		<li class="nav-item">
  		...
  		<li class="nav-item">
    		<a class="nav-link" href="indexmarcas.php">Marcas</a>
  		</li>
  		<li class="nav-item">
    		<a class="nav-link" href="indexfacturacion.php">Facturación</a>
  		</li>
	</ul>
</div>
</body>
